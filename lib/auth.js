...
// Files (photos, PDFs) a single room can hold. Keeps storage from bloating; nothing saved is ever taken away.
export const ROOM_FILES = { free: 5, paid: 25 };
export function fileLimitFor(plan) { return plan === 'paid' ? ROOM_FILES.paid : ROOM_FILES.free; }
...
// Account deletion (Settings > Delete account). Removes the Clerk user for good.
