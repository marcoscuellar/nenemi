...
.eb{display:none!important;position:absolute;left:26px;top:36px;display:flex;align-items:center;gap:9px;font:14px 'Archivo Black',sans-serif;letter-spacing:.3em;color:${x.dark?'#F5F6F5':'#111312'};z-index:5}.eb svg{width:23px;height:auto}.eb path{fill:${x.dark?'#F5F6F5':'#111312'}}
.copy{position:absolute;left:26px;top:40px;width:362px;z-index:5}
