...
.def{position:absolute;inset:0;background:#050404 url('file:///home/user/nenemi/photos/texture/tex-fret.webp') right center/cover no-repeat}.def:before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 70% 60% at 50% 50%,rgba(8,6,5,.6),rgba(8,6,5,.15))}.dc{position:absolute;left:28px;right:28px;top:50%;transform:translateY(-50%);display:flex;flex-direction:column;align-items:center;text-align:center;gap:22px}.dc svg{width:42px;height:auto;filter:drop-shadow(0 12px 34px rgba(0,0,0,.75))}.dc path{fill:#f4f1ea}.d-e{font:700 11px ui-monospace,Menlo,'DejaVu Sans Mono',monospace;letter-spacing:.2em;color:#3C8692}.d-n{font:16px 'Archivo Black',sans-serif;letter-spacing:.16em;color:#9aa0a2;margin-top:-10px}.d-s{font:50px/1 'Archivo Black',sans-serif;letter-spacing:-.02em;color:#f4f1ea;margin-top:-6px}.d-t{font:500 16px/1.65 Archivo,sans-serif;color:#9aa0a2}</style></head><body>
