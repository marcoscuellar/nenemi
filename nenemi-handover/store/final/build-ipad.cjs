...
.def{position:absolute;left:96px;right:96px;top:50%;transform:translateY(-50%)}.d-l{font:600 18px Archivo,sans-serif;letter-spacing:.28em;color:#5AA6B0}.d-w{margin-top:26px;font:132px/1 'Archivo Black',sans-serif;letter-spacing:.06em;color:#F5F6F5}.d-p{margin-top:22px;font:500 38px Archivo,sans-serif;color:#B9BEBD}.d-p i{font-style:normal;color:#5AA6B0}.d-r{margin:48px 0;height:2px;background:#2A2D2D}.d-m{font:500 32px/1.45 Archivo,sans-serif;color:#E6E8E7}.d-m b{font-family:'Archivo Black',sans-serif;font-weight:400}.d-s{margin-top:28px;font:500 26px/1.45 Archivo,sans-serif;color:#9AA0A2}</style></head><body>
