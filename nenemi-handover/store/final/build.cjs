...
const P=[
 {shot:'03-day', fs:33, h:'Get the noise out.<br>Get a day back<b>.</b>', sub:'Type it, say it, start in the middle. You don&rsquo;t have to organize your thoughts before putting them here. NENEMI helps you see what matters today and find a place to begin.', a:'photos/originals/kitchen-table.png', ap:'62% 40%', b1:'photos/originals/jacket-messy-bed.jpg', b1p:'50% 30%', b2:'photos/prove-workbench.jpg', b2p:'75% 40%'},
 {shot:'02-room', fs:38, h:'Never pretend<br>you remembered<b>.</b>', sub:'That project, the conversation you need to finish, the thing you meant to do next&mdash;give each its own Room. NENEMI keeps the context together, so you can leave when you need to and come back knowing where you were.', a:'photos/originals/fabric-wall-designer.png', ap:'64% 30%', b1:'photos/originals/desk-stretch.png', b1p:'52% 30%', b2:'photos/contact-team.jpg', b2p:'55% 30%'},
 {shot:'04-stuck', dark:true, fs:40, h:'You had a plan.<br>Then the day<br>happened<b>.</b>', sub:'A plan can make sense at 9 AM and feel impossible by 1 PM. Tell NENEMI where you are right now. It helps you find one small way back in.', a:'photos/originals/floor-mms.png', ap:'72% 40%', b1:'photos/originals/desk-eyes-closed.png', b1p:'72% 30%', b2:'photos/originals/man-late.png', b2p:'50% 35%'},
...
for(const [slot,sc] of [['6.5',1],['6.7',430/414]]){
 ...
 const dir=S+'/frames/v9-'+slot;fs.rmSync(dir,{recursive:true,force:true});fs.mkdirSync(dir);
