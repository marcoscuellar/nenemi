...
const F=[
 ...
 {n:'04', shot:'07-recap', photo:'photos/wall.jpg', pos:'40% center', fs:9.4, h:'The day ends.<br>What mattered stays<b>.</b>', sub:'Say what happened, messy is fine. NENEMI holds what matters, gives one leftover a home, and lets the rest go. Nothing carries over unless you choose it.'},
