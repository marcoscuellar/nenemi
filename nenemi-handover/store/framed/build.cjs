...
const F=[
 {n:'01-home', shot:'01-home', photo:'photos/originals/kitchen-table.png', pos:'56% center', h:'Put it down<br>Walk away<b>.</b>', dark:false},
...
const page=(f,slot)=>`<!doctype html><html><head><link href="https://fonts.googleapis.com/css2?family=Archivo:wght@500;800&family=JetBrains+Mono:wght@600&display=swap" rel="stylesheet"><style>
*{margin:0;box-sizing:border-box}html,body{width:100vw;height:100vh;overflow:hidden}
body{background:${f.dark?'#070707':'#eeeff1'};position:relative;font-family:Archivo,sans-serif}
...
.eb{position:absolute;left:6vw;top:5vh;font:600 3vw 'JetBrains Mono',monospace;letter-spacing:.32em;color:#13b3a5}
h1{position:absolute;left:6vw;top:7.4vh;font-weight:800;font-size:11.6vw;line-height:.98;letter-spacing:-.02em;word-spacing:.04em;color:${f.dark?'#fff':'#0b0b0b'}}
h1 b{color:#13b3a5}
...
</style></head><body><div class="photo"></div><div class="eb">NENEMI</div><h1>${f.h}</h1>
