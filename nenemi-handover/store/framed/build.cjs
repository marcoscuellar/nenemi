...
const W=414,H=896;
const LAY=[
 {py:300, a:[16,330,236,250,0], b1:[578,36,176,300,0], b2:[610,362,250,380,0]},
 {py:250, a:[-18,560,250,300,0], b1:[572,150,238,240,0], b2:[578,410,160,250,0]},
 {py:330, a:[18,262,200,340,0], b1:[586,40,244,300,0], b2:[604,370,270,250,0]},
 {py:262, a:[-30,500,270,330,0], b1:[572,60,170,250,0], b2:[586,340,236,400,0]},
 {py:300, a:[16,320,236,270,0], b1:[586,40,230,340,0], b2:[570,400,184,300,0]},
];
...
const page=slot=>{let out='';P.forEach((p,i)=>{const o=i*2*W;
 ...
 out+=`<div class="phone" style="left:${o+W-131}px;top:${LAY[i].py}px"><img src="file://${S}/store/${slot}/${p.shot}.png"></div>`;
});
