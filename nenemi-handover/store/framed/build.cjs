...
const F=[
 ...
 {n:'02-room', shot:'02-room', photo:'photos/originals/fabric-wall-designer.png', pos:'44% center', h:'Never lose<br>your place<b>.</b>', dark:false},
...
.sub{position:absolute;left:6vw;top:${f.sub?'22.4vh':'0'};font:500 4vw/1.35 Archivo,sans-serif;color:${f.dark?'#B9BEBD':'#63696A'}}
...
</style></head><body><div class="photo"></div><div class="eb">${MARK}NENEMI</div><h1>${f.h}</h1>${f.sub?'<p class="sub">'+f.sub+'</p>':''}
