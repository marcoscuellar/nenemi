# NENEMI — Positioning & Competitive Strategy

## The core bet
NENEMI targets the single biggest failure point of traditional productivity apps for neurodivergent users: **backlog guilt and context collapse.**
...
| Competitor | Core positioning | Strengths | Where NENEMI wins |
|---|---|---|---|
...
Standard to-do apps turn red or pile yesterday's undone tasks into a 40-item mountain. NENEMI gives explicit, judgment-free permission: "Let's leave that in the past — it wasn't that important." Prevents the debt buildup that makes users delete the app.
...
- **Over-scheduling trap:** Auto-schedulers cram 8 hours into an 8-hour day. NENEMI planner should enforce buffer time — schedule only 60–70% of available hours — to prevent immediate plan failure.
