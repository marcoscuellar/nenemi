// Speech recognition for the Nenemi shell, using Apple's on-device recognizer.
// Adapted from @capacitor-community/speech-recognition 7.0.1 (MIT) and registered
// the Capacitor 8 way (CAPBridgedPlugin) so it works without CocoaPods.
// The page talks to it as Capacitor.Plugins.SpeechRecognition: start, stop,
// requestPermissions, and the partialResults / listeningState events.
